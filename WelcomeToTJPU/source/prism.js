/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism-funky&languages=markup+css+clike+javascript+markdown */
            ...
            for (var b = a, k = l; b < t.length; k += t[b].length, ++b) {
              ...
              if (!(w instanceof s)) {
                ...
                if (_) {
                  ...
                  var j = _.index + p, _ = _[0].slice(p), P = j + _.length, N = w.slice(0, j), S = w.slice(P),
                    C = [b, I];
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (lglobal.Prism = Prism);
